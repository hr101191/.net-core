...
namespace ProtoActorWebApiDemo.DataAccess
{
    ...
    public class DataAccessService : IDataAccessService
    {
        ...
        /// <summary>
        /// Dummy method to initialize db data
        /// </summary>
        public async Task InitData()
        {
            await ExecuteAsync("DROP TABLE IF EXISTS beer");
            await ExecuteAsync("DROP TABLE IF EXISTS brewery");
            await ExecuteAsync("CREATE TABLE beer(Id INTEGER PRIMARY KEY AUTOINCREMENT, Name VARCHAR(50), Company VARCHAR(50), Style VARCHAR(50))");
            await ExecuteAsync("CREATE TABLE brewery(Id INTEGER PRIMARY KEY AUTOINCREMENT, Name VARCHAR(50), Country VARCHAR(50), CEO VARCHAR(50), Year_Est INT)");
            await ExecuteAsync("INSERT INTO beer (Name, Company, Style) VALUES('Miller Lite', 'Molson Coors Beverage Company', 'Pale Lager')");
            await ExecuteAsync("INSERT INTO beer (Name, Company, Style) VALUES('Corona Extra', 'AB InBev', 'Pale Lager')");
            await ExecuteAsync("INSERT INTO beer (Name, Company, Style) VALUES('Somersby cider', 'Carlsberg A/S', 'Cider')");
            await ExecuteAsync("INSERT INTO beer (Name, Company, Style) VALUES('Heineken Lager Beer', 'Heineken N.V', 'Pale Lager')");
            await ExecuteAsync("INSERT INTO brewery (Name, Country, CEO, Year_Est) VALUES('AB InBev', 'Belgium', 'Carlos Brito', 2008)");
            await ExecuteAsync("INSERT INTO brewery (Name, Country, CEO, Year_Est) VALUES('Heineken N.V', 'Netherlands', 'Jean-François van Boxmeer', 1864)");
            await ExecuteAsync("INSERT INTO brewery (Name, Country, CEO, Year_Est) VALUES('Carlsberg A/S', 'Denmark', 'Cees ''t Hart', 1847)");
            await ExecuteAsync("INSERT INTO brewery (Name, Country, CEO, Year_Est) VALUES('Molson Coors Beverage Company', 'USA', 'Gavin Hattersley', 2005)");
        }
